================================================================================
                       WSO2 Integrator: WebSubHub @version@
================================================================================

Welcome to the WSO2 Integrator: WebSubHub @version@ release.
...
Installation:
-------------
1. Extract the wso2websubhub-distribution-@version@.zip file

2. The distribution contains both services:
   - wso2websubhub-@version@ (WebSubHub service)
   - wso2websubhub-consolidator-@version@ (Consolidator service)
...
1. Navigate to the wso2websubhub-consolidator-@version@ directory
...
1. Navigate to the wso2websubhub-@version@ directory
